...
project = u'ProGeek'
author = u'Zaharia Constantin and others'
copyright = u'2022-2023, {}'.format(author)
...
# of the sidebar.
html_logo = '_static/images/progeek-50x37.png'
...
latex_documents = [
  ('index', 'ProGeek.tex', u'ProGeek Documentation',
   u'ProGeek Developers', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '_static/images/progeek-50x37.png'
...
man_pages = []
# man_pages = [
#     ('index', 'progeek', u'ProGeek Documentation',
#      [author], 1)
# ]
...
for element in os.listdir(rst_ansible_roles):
            ...
            for line in f:
                ...
                if (not role_description and
                        (line.startswith(element) or
                         line.startswith('progeek.' + element))):
    ...
    if os.path.isfile(rst_ansible_roles + element + '/man_index.rst'):
        man_pages.append((rst_ansible_roles + element + '/man_index',
                          'progeek.' + element, role_description,
                          role_authors, 5))
...
texinfo_documents = [
  ('index', 'ProGeek', u'ProGeek Documentation',
   author, 'ProGeek', 'Your Debian-based data center in a box',
   'Miscellaneous'),
]
...
epub_title = u'ProGeek'
epub_author = author
epub_publisher = author
epub_copyright = u'2022-2023, Zaharia Constantin'

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'ProGeek'
